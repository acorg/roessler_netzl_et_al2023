library(Racmacs)
set.seed(100)
neut <- read.acmap('revision/GMT_map/gmt_map.ace')
...
png("revision/bootstrapping_gmt_map/bootstrapping_gmt_sera.png", width = 8, height = 8, units = 'in', res=300, pointsize = 18)
...
getwd()
png("revision/bootstrapping_gmt_map/bootstrapping_gmt_sera.png", width = 10, height = 6, units = 'in', res=300, pointsize = 18)
layout(matrix(c(1:length(target_srgs)), ncol = 4, byrow = T))
par(oma=c(0, 0, 0, 0), mar=c(0.1, 0, 1, 0))
